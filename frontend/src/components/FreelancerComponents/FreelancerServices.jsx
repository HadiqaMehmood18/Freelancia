            ...
            <div className="services">
              {data?.allServices && data.allServices.length != 0 ? data.allServices.map(service => <div key={service._id} className="service">
                ...
                <div className="serviceHeader">
                  <img src={avatar === 'no-image.png' ? noImage : `${process.env.REACT_APP_API_URL}/ProfilePic/${avatar}`} alt="Service" />
                ...
                <div className="serviceBody">
                  ...
                  <div className="rating-more">
                    ...
                    <HashLink to={`/dashboard/freelancer/${id}/services/show/${service._id}`}> <button>See More</button></HashLink>
                  </div>
                </div>
                <hr />
