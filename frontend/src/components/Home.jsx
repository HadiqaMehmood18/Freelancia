...
export default function Home() {
    ...
    useEffect(() => {
        ...
        // Always show intro animation on Home page load (first load or reload)
        setShowIntro(true);
    }, [])

    const handleIntroFinish = () => {
        // Do not set localStorage flag, so animation shows on every Home page load
        setShowIntro(false);
    }
    ...
    const handleSubmit = (e) => {
        ...
        if ((myForm.fullName === "" && myForm.email === "" && myForm.message === "") || err.length !== 0) {
        ...
        <div className='Home'>
            <div className="container">
                ...
                <section>
                    <div className="services" id='services'>
                        ...
                        <div className="service">
                            <div className="service-headline">Mobile App Development</div>
                            <div className="service-description">
                                <div data-aos="fade-right">
            ...
            <footer>
                ...
                <p className="footer-body">
                    Freelancia is a leading provider of freelance services, connecting talented individuals with clients who need their skills and expertise. From website design and development to writing and marketing, our team has the knowledge and experience to help you succeed.
                </p>
                <div className="footer-footer">
                    <div className="copyright">
                        Copyright Freelancia ©2025 | All Rights Reserved
                    </div>
                    <div className="socials">
                        <a href="https://www.instagram.com/hadiqamehmood18" target="_blank" rel="noopener noreferrer">
