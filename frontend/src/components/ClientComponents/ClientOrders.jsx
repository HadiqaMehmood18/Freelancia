                                ...
                                newdata && newdata.length != 0 ? newdata.map(order =>
                                    ...
                                    <div key={order._id} className="service">
                                        ...
                                        <div className="serviceHeader">
                                            <img src={order.serviceUserInfo.image === 'no-image.png' ? noImage : `http://localhost:1900/ProfilePic/${order.serviceUserInfo.image}`} alt="" />
                                        ...
                                        <div className="serviceState">
                                            Status: {order.status == "OnGoing" ? <span className="ongoing">OnGoing</span> : order.status == "Cancelled" ? <span className="cancelled">Cancelled</span> : <span className="completed">Completed</span>}
                                        </div>
                                    </div>)
                                    :
